...
public class Principal extends javax.swing.JFrame {
    ...
    public Principal() {
        this.setUndecorated(true); //Para quitar la barra de la ventana.
        initComponents();
        this.setLocationRelativeTo(null); //Para que la ventana aparezca en el centro de la pantalla.
        //Para redondear bordes de la ventana.
    ...
    private void initComponents() {
        ...
        jTextField3.setBackground(new java.awt.Color(32, 30, 42));
        jTextField3.setFont(new java.awt.Font("Bahnschrift", 1, 60)); // NOI18N
        jTextField3.setForeground(new java.awt.Color(249, 255, 255));
        jTextField3.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextField3.setText("Registro de Personas");
        ...
        jPanelPrincipal.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 110, 650, 120));
